...
# ── MAINTENANCE ───────────────────────────────────────────────────────────
    maintenance)
        ...
        _R "lichtar update"          "self-update + plugins + yazi packages; successful self-update restarts the interactive shell"
        ...
        _N "Succeeds → shows new CHANGELOG.md entries and restarts the interactive shell when invoked as an interactive command."
    ...
    all|*)
        ...
        _R "lichtar update"       "self-update + plugins + yazi packages; restarts after self-update"
